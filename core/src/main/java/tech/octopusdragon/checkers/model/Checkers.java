...
public class Checkers implements Serializable {
	...
	public Player bottomPlayer() {
		return Board.bottomPlayerType() == PlayerType.BLACK ? blackPlayer : whitePlayer;
	}
	...
	*/
    ...
    public boolean isValidMove(Move move) {
        return isValidMove(getBoard().getPiece(move.getFromPos()), move.getToPos().getRow(), move.getToPos().getCol());
    }
    ...
    public boolean isValidCapture(Move move) {
        return isValidCapture(getBoard().getPiece(move.getFromPos()), move.getToPos().getRow(), move.getToPos().getCol());
    }
