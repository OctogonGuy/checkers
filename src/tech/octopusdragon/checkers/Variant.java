...
import tech.octopusdragon.checkers.rules.BoardPattern;
import tech.octopusdragon.checkers.rules.KingType;
import tech.octopusdragon.checkers.rules.KingVKingAutomaticDrawRule;
import tech.octopusdragon.checkers.rules.KingVKingDrawRule;
import tech.octopusdragon.checkers.rules.KingsRowCapture;
import tech.octopusdragon.checkers.rules.StartingPlayer;
import tech.octopusdragon.checkers.rules.StartingPositions;
	...
	private Variant() {
		...
		try {
			inputStream = Variant.class.getClassLoader().getResourceAsStream(
					"resources/text/variant_descriptions/" + name().toLowerCase() + ".txt");
